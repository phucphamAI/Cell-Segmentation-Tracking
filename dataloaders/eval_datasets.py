...
class CellDemo(Dataset):
    ...
    def sample_sequence(self, idx):
        ...
        curr_images        = self.get_img_cell(img_path[i])
        curr_labels        = self.get_label_cell(label_path[i])
        
        sample = {

            'current_img': curr_images,
            'current_label':curr_labels
        }
        
        sample['meta'] = {
            'obj_num': self.max_obj_n,
            'current_name': img_path[i],
            'height':curr_images.shape[0],
            'width':curr_images.shape[1],
            'obj_idx': 1,
        }
