...
from dataloaders.train_datasets import DAVIS2017_Train, YOUTUBEVOS_Train, StaticTrain, TEST, CELL_Train
...
class Trainer(object):
    ...
    def prepare_dataset(self):
        ...
        if "cell" in cfg.DATASETS:
            
            train_cell_dataset = CELL_Train(
                root = cfg.DIR_CELL,
                transform=composed_transforms,
                enable_prev_frame=self.enable_prev_frame,
                max_obj_n=cfg.MODEL_MAX_OBJ_NUM)
            ...
            train_datasets.append(train_cell_dataset)
